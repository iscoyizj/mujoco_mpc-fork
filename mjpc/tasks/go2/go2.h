...
namespace mjpc
{
  ...
  public:
    ...
    private:
      ...
      //  ============  constants  ============
      constexpr static Go2Foot kFootAll[kNumFoot] = {kFootFL, kFootHL,
                                                     kFootFR, kFootHR};
      constexpr static Go2Foot kFootHind[2] = {kFootHL, kFootHR};
      constexpr static Go2Gait kGaitAll[kNumGait] = {kGaitStand, kGaitWalk,
      ...
      void FootStep(double step[kNumFoot], double time, Go2Gait gait) const;
      ...
      Go2Mode current_mode_ = kModeQuadruped;
